...
const STATIC_COMMANDS = [
  ...
  { id: 'go-new-project', label: 'Create new project', hint: 'Navigation', path: '/projects/new' },
  ...
  { id: 'go-interests', label: 'Go to Interests', hint: 'Navigation', path: '/interests' },
  { id: 'go-invitations', label: 'Go to Invitations', hint: 'Navigation', path: '/invitations' },
