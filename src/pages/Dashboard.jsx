...
export default function Dashboard() {
  ...
  const { counts: unreadCounts, total: liveUnreadTotal } = useUnreadMessages();
    ...
    <div className="main-scroll" style={{ flex: 1, overflowY: 'auto', padding: '20px 20px 28px' }}>
      ...
      >
        ...
        <MetricCard
          ...
          value={String(liveUnreadTotal || stats.unread_messages || 0)}
          badge={liveUnreadTotal || stats.unread_messages || 0}
          href="/notifications"
        />
      </div>
        ...
        <div className="dashboard-projects-scroll">
          <div className="dashboard-projects-grid">
            {projects.map((p) => {
              ...
              const live = Object.prototype.hasOwnProperty.call(unreadCounts, key)
                ? Number(unreadCounts[key]) || 0
                : undefined;
              return <ProjectCard key={p.id} project={p} unreadCount={live} />;
            })}
